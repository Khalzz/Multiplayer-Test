...
pub struct Timing {
    pub delta_time_duration: Duration,
    pub delta_time: f32,
    last_frame: Instant,
    frame_count: u32,
...
impl Timing {
    pub fn new() -> Self {
        Self {
            delta_time_duration: Duration::ZERO,
            delta_time: 0.0,
    ...
    fn calculate_delta_time(&mut self) {
        ...
        self.delta_time_duration = current_time.duration_since(self.last_frame);
        self.delta_time = self.delta_time_duration.as_secs_f32();
